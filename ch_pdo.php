...
$count=$db_obj->update("category", $update_data, $where_condition);
echo $count."<br>";
$result=$db_obj->query("category",null,"name='phones' and id='3'");
   $insert_data = array(  
           'id'     =>    null,  
           'name'          => "lapppms" ,
           'active'   => "0" 
      );
// $count=$db_obj->insert("category",$insert_data);
foreach($result as $row)
 {
